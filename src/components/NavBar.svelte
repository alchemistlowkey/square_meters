  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="hidden md:flex items-center">
        ...
        <div class="relative dropdown">
          <button
            ...
            class="inline-flex items-center px-3 py-2 hover:text-gray-900 focus:outline-none"
            aria-haspopup="true"
          ...
          <!-- Dropdown Menu -->
          <div
            class={`dropdown-menu container absolute left-0 mt-2 w-80 bg-[#F6FFFD] border border-gray-200 rounded-md shadow-lg ${isProductsDropdownOpen ? "block" : "hidden"}`}
          >
            <NavDropCard
              dropheader="Land"
        ...
        <div class="relative dropdown ml-4">
          ...
          <!-- Dropdown Menu -->
          <div
            class={`dropdown-menu absolute left-0 mt-2 w-80 bg-white border border-gray-200 rounded-md shadow-lg ${isCompanyDropdownOpen ? "block" : "hidden"}`}
          >
            <NavDropCard
              dropheader="About Us"
      ...
      <div class="flex md:hidden items-center">
        <button
          on:click={toggleMenu}
          class="inline-flex items-center justify-center p-2 rounded-md text-[#0D493D] hover:text-[#13705D] hover:bg-gray-100 focus:outline-none"
        >
          <svg
            class="h-6 w-6"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class={`md:hidden ${isMenuOpen ? "block" : "hidden"}`}>
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a
          ...
          class="block px-2 py-2 w-40 rounded-md text-base font-medium bg-[#0D493D] hover:bg-[#13705D] text-[#F6FFFD]"
